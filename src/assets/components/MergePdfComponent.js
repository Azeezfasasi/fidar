...
function ImportPdfComponent() {
    return (
        ...
        <div className="frame-3045">
            <div className="merge-pdf">Merge PDF</div>
        ...
        <div className="how-to-action-wrapper">
            <div className="how-to-merge-pdf">How to Merge PDF</div>
            <div className="how-to-box">
                ...
                <div className="how-to-flow">
                    ...
                    <div className="frame-3048">
                        ...
                        Select 2 or more PDF documents to upload to our system
                        </div>
                        <div className="upload-the-pdf-files-from-a-pc-or-smart-phone">
                        Upload the PDF files from a PC or smart phone
                        </div>
                        <div className="download-your-new-pdf">Download your new PDF</div>
                    </div>
                </div>
            </div>
        </div>
...
export default ImportPdfComponent;